...
if ($request54) {
    echo 'ID: ' . $request54->id . PHP_EOL;
    echo 'Loai Su Co ID: ' . $request54->loai_su_co_id . PHP_EOL;
...
if ($request55) {
    echo 'ID: ' . $request55->id . PHP_EOL;
    echo 'Loai Su Co ID: ' . $request55->loai_su_co_id . PHP_EOL;
...
foreach ($teams as $team) {
    echo 'Team ID: ' . $team->id . ', Name: ' . $team->ten_doi . ', Loai Su Co: ' . $team->loai_su_co_id . ', Capacity: ' . $team->so_luong_thanh_vien . ', Location: ' . $team->vi_tri_hien_tai . PHP_EOL;
